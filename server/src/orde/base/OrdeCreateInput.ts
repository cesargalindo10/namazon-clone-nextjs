...
class OrdeCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProductCreateNestedManyWithoutOrdesInput,
  })
  @ValidateNested()
  @Type(() => ProductCreateNestedManyWithoutOrdesInput)
  @IsOptional()
  @Field(() => ProductCreateNestedManyWithoutOrdesInput, {
    nullable: true,
  })
...
export { OrdeCreateInput as OrdeCreateInput };
